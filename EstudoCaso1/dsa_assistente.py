...
#Eu tenho que colocar esse with porque é como se eu dissese ao python, com esse objeto de contêiner (retorno do st.sidebar), coloque o que eu vou te mostrar.
with st.sidebar:
